...
class BallRenderer {
    ...
    initScene() {
        ...
        for (var i = 0; i < ballCount; i++) {
            ...
            var position = new Vec2(randomI(paddingX, this.canvas.width - paddingX), randomI(paddingY, this.canvas.height - paddingY));
...
class Colour {
    ...
    static lerp(source, target, t) {
        ...
        return new Colour(source.r + t * dr, source.g + t * dg, source.b + t * db, source.a + t * da);
    }
}
...
//# sourceMappingURL=balls-compiled.js.map